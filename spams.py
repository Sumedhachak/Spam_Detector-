...
data1 = data1.append(dffromdirectory(r'D:\data_science\Projects\spam\emails\spam', 'spam'))
data1 = data1.append(dffromdirectory(r'D:\data_science\Projects\spam\emails\ham', 'ham'))
